...
function Home() {
  return (
    <div className="container pt-4">
      ...
      <h2 className="text-4xl font-bold col-span-2 mt-5">Your forms</h2>
  ...
  return (
    <div className="w-full pt-8 gap-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
      ...
      <StatsCard
        ...
        icon={<SubtitlesIcon className="text-green-600" />}
      ...
      <StatsCard
        title="Bounce rate"
        icon={<ArrowBigUpDashIcon className="text-red-600" />}
        ...
        {form.published && (
          <Button asChild className="w-full mt-2 text-md gap-4">
            <Link href={`/forms/${form.id}`}>
              View submissions <ArrowRightCircleIcon />
            </Link>
          </Button>
        )}
        {!form.published && (
